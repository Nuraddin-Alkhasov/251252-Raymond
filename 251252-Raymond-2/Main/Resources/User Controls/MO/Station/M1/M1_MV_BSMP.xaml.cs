        ...
        private MVBasket GetBasket(string Basket, Thickness margin, int ManiPos) 
        {
            ...
            switch (Basket)
            {
                case "L":
                    ...
                    temp.SetLayer = "CPU1.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[1].Set";
                    temp.ActualLayer = "CPU1.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[1].Actual";
                    temp.AS = "Set";
