        ...
        private MVTray GetCZTray(int i)
        {
            if (i >= 0 && i <= 1) 
            {
                return new MVTray()
                {
                    ...
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].Charge.Layer[1].Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.01.00 Main.DB CZ 1 PD.Place[" + i + "].Charge.Layer[1].Actual",
            ...
            if (i >= 2 && i <= 3)
            {
                return new MVTray()
                {
                    ...
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].Charge.Layer[1].Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.02.00 Main.DB CZ 2 PD.Place[" + (i - 2).ToString() + "].Charge.Layer[1].Actual",
            ...
            if (i >= 4 && i <= 5)
            {
                return new MVTray()
                {
                    ...
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].Charge.Layer[1].Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.03.00 Main.DB CZ 3 PD.Place[" + (i - 4).ToString() + "].Charge.Layer[1].Actual",
            ...
            if (i >= 6 && i <= 7)
            {
                return new MVTray()
                {
                    ...
                    SetLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].Charge.Layer[1].Set",
                    ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.07 CZ.04.00 Main.DB CZ 4 PD.Place[" + (i - 6).ToString() + "].Charge.Layer[1].Actual",
