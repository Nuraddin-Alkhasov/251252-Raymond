        ...
        private MVBasket GetBasket(string Basket, Thickness margin, int ManiPos) 
        {
            ...
            switch (Basket)
            {
                case "L":
                    ...
                    temp.SetLayer = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[0].Set";
                    temp.ActualLayer = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[0].Actual";
                    temp.AS = "Set";
