    ...
    public partial class M2_HZ
    {
        ...
        private HZTray_L GetHZTray_L(int i, bool head, byte hz)
        {
            return new HZTray_L()
            {
                ...
                SetLayer = "CPU4.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].Charge.Layer[0].Set",
                ActualLayer = "CPU4.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].Charge.Layer[0].Actual",
