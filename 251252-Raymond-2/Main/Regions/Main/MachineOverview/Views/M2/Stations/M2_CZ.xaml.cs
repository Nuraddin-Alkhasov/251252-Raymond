    ...
    public partial class M2_CZ
    {
        ...
        private CZTray GetCZTray(int i, bool head, byte cz)
        {
            return new CZTray()
            {
                ...
                SetLayer = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Charge.Layer[0].Set",
                ActualLayer = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Charge.Layer[0].Actual",
