    ...
    public partial class M2_PZWZ
    {
        ...
        private PZWZTray GetPZWZTray(int i, bool head)
        {
            return new PZWZTray()
            {
                ...
                SetLayer = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer[0].Set",
                ActualLayer = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer[0].Actual",
