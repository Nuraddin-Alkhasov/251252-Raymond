    ...
    public partial class M1_HZ
    {
        ...
        private HZTray_L GetHZTray_L(int i, bool head, byte hz)
        {
            return new HZTray_L()
            {
                ...
                SetLayer = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].Charge.Layer[1].Set",
                ActualLayer = "CPU2.PLC.Blocks.04 Tray handling.06 HZ.0" + hz + ".00 Main.DB HZ " + hz + " PD.Place[" + i + "].Charge.Layer[1].Actual",
