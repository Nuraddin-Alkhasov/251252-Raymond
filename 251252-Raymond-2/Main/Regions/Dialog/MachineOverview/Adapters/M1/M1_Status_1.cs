...
{
    [ExportAdapter("M1_Status_1")]
    public class M1_Status_1 : AdapterBase
    {
        ...
        private void CloseExecuted(object parameter)
        {
            ...
            Views.M1_Status_1 v = (Views.M1_Status_1)iRS.GetView("M1_Status_1");
        ...
        {
            ApplicationService.SetView("DialogRegion2", "Recipe_Selector", "M1_Status_1");
        }
        #endregion
        ...
        protected override void OnViewLoaded(object sender, ViewLoadedEventArg e)
        {
            ...
            {
                SPData = ApplicationService.ObjectStore.GetValue("M1_Status_1_KEY") as SP;
                ApplicationService.ObjectStore.Remove("M1_Status_1_KEY");
                ...
                ; switch (SPData.Type)
                {
                    case "Box": Content = new M1_Status_Box1(); break;
        ...
        public void SetData(int _mrId)
        {
            ...
            if (_mrId > 0)
            {
                ...
                byte actualLayer = (byte)ApplicationService.GetVariableValue("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[1].Actual");
                ...
                ApplicationService.SetVariableValue("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[1].Set", counter);
