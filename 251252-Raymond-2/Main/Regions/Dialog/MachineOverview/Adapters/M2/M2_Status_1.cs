    ...
    public class M2_Status_1 : AdapterBase
    {
        ...
        public void SetData(int _mrId)
        {
            ...
            if (_mrId > 0)
            {
                ...
                byte actualLayer = (byte)ApplicationService.GetVariableValue("CPU3.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[0].Actual");
                ...
                ApplicationService.SetVariableValue("CPU3.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[0].Set", counter);
