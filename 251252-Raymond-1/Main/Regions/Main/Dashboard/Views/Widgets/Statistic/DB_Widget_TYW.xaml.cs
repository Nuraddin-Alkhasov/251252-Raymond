...
{
    [ExportDashboardWidget("DB_Widget_TYW", "Dashboard.Text27", "@Dashboard.Text13", 1, 2)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class DB_Widget_TYW : View
    {
        public DB_Widget_TYW()
        {
        ...
        {
            DataTable D1 = new MSSQLEAdapter("Orders", "SELECT Sum(Weight) as Weight " +
                                    "FROM Charges " +
            ...
            DataTable D2 = new MSSQLEAdapter("Orders", "SELECT Sum(Weight) as Weight " +
                                                 "FROM Charges " +
            ...
            DataFromSQL[0] = D1.Rows.Count == 0
                ? 0.0
                : D1.Rows[0]["Weight"] != System.DBNull.Value ? Math.Round(Convert.ToDouble(D1.Rows[0]["Weight"]), 1) : 0.0;

            DataFromSQL[1] = D2.Rows.Count == 0
                ? 0.0
                : D2.Rows[0]["Weight"] != System.DBNull.Value ? Math.Round(Convert.ToDouble(D2.Rows[0]["Weight"]), 1) : 0.0;
        }
