...
namespace HMI.MainRegion.MO.Views
{
    ...
    public partial class M2_CD
    {
        ...
        public M2_CD()
        {
            ...
            DTPosition = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.02 DT.01 Lift.DB DT Lift HMI.Actual.Drive.Position");
            DTPosition.Change += DTPosition_Change;
            IsDT = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.02 DT.00 Main.DB DT PD.Tank.Available");
            IsDT.Change += IsDT_Change;
            VC = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.02 DT.00 Main.DB DT HMI.Actual.Viscosity.Expired");
            VC.Change += VC_Change;
            Paint = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.02 DT.00 Main.DB DT PD.Header.Paint");
        ...
        private void CoatingStep_Change(object sender, VariableEventArgs e)
        {
            if (e.Quality.Data == DataQuality.Good)
            {
                ...
                switch ((byte)e.Value)
                {
                    case 1: content = new M2_CD_Dip(); break;
                    case 2: content = new M2_CD_Spin(); break;
        ...
        {
            StepType = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.01 CD.00 Main.Program.DB Program control.Set.Data.Type");
        ...
        {
            ApplicationService.SetView("DialogRegion1", "M2_Coating_DT");
            
        }

        private void Button_Click_4(object sender, RoutedEventArgs e)
        {
            ApplicationService.SetView("DialogRegion1", "M2_Coating_VC");
        }
