...
namespace HMI.MainRegion.MO
{
    ...
    public partial class M2_CZ
    {
        ...
        {
            InitializeComponent();
            Clocked = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.00 Main.DB CZ HMI.Parameter.Stack[0].Id";
        ...
        private void IVClocked_ValueChanged(object sender, VariableEventArgs e)
        {
            if (e.Quality.Data == DataQuality.Good)
            {
                if (this.IsVisible)
                {
                    byte CZ = (byte)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.04 Tray handling.07 CZ.00 Main.DB CZ HMI.Parameter.Stack[0].Id");
                    CZ = (byte)(CZ == 1 ? 15 : CZ == 2 ? 16 : CZ == 3 ? 17 : 18);
                    byte Place = (byte)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.04 Tray handling.07 CZ.00 Main.DB CZ HMI.Parameter.Stack[0].Place");
        ...
        private CZTray GetCZTray(int i, bool head, byte cz)
        {
            return new CZTray()
            {
                IsTray = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Tray.Available",
                IsMaterial = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Charge.Available",
                SetLayer = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Charge.Layer[1].Set",
                ActualLayer = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Charge.Layer[1].Actual",
                IsDischarge = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Tray.Functions.Discharge",
                IsWatch = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Tray.Functions.Watch",
                Charge = "CPU4.PLC.Blocks.04 Tray handling.07 CZ.0" + cz + ".00 Main.DB CZ " + cz + " PD.Place[" + i + "].Header.Charge",
