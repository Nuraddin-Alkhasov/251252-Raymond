...
namespace HMI.MainRegion.MO.Views
{
    ...
    [ExportView("M2_CD_Spin")]
	public partial class M2_CD_Spin
    {
        ...
        public M2_CD_Spin()
		{
            ...
            SpinType = VS.GetVariable("CPU3.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.Actual.Spin type");
