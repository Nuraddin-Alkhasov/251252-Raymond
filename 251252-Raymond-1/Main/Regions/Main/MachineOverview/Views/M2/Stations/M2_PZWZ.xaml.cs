...
namespace HMI.MainRegion.MO
{
    ...
    public partial class M2_PZWZ
    {
        ...
        private PZWZTray GetPZWZTray(int i, bool head)
        {
            return new PZWZTray()
            {
                IsTray = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Tray.Available", 
                IsMaterial = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Available",
                SetLayer = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer[1].Set",
                ActualLayer = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Charge.Layer[1].Actual",
                IsDischarge = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Tray.Functions.Discharge",
                IsWatch = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Tray.Functions.Watch",
                Charge = "CPU4.PLC.Blocks.04 Tray handling.03 TO.00 Main.DB TO PD.Place[" + i + "].Header.Charge",
                Station = 12,
                Place = i,
                Head = head,
                Type = "Tray",
