    ...
    public class Header : AdapterBase
    {
        ...
        protected override void OnViewLoaded(object sender, ViewLoadedEventArg e)
        {
            if (sender.GetType().Name == e.View.GetType().Name)
            {
                ...
                VW_CPU3 = VS.GetVariable("CPU3.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.General.ToggleBit");
                VW_CPU3.Change += VW_CPU3_Change;
                VW_CPU4 = VS.GetVariable("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.General.ToggleBit");
