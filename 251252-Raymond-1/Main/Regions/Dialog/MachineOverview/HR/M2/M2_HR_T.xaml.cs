    ...
    public partial class M2_HR_T
    {
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            if (MessageBoxView.Show("@MachineOverview.Text53", "@RecipeSystem.Text58", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                Task taskA = Task.Run(() =>
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.On", true);
                });
                taskA.ContinueWith(async x =>
                {
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.On", false);
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            if (MessageBoxView.Show("@MachineOverview.Text53", "@RecipeSystem.Text58", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                Task taskA = Task.Run(() =>
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Off", true);
                });
                taskA.ContinueWith(async x =>
                {
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Off", false);
        ...
        private void Button_Click_3(object sender, RoutedEventArgs e)
        {
            ...
            {
                if ((byte)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.to.Heat treatment.Option.State.Solvent") == 0)
                {
                    Task taskA = Task.Run(() =>
                    {
                        ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Solvent.On", true);
                    });
                    taskA.ContinueWith(async x =>
                    {
                        await Task.Delay(1000);
                        ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Solvent.On", false);
                ...
                else
                {
                    ...
                    Task taskA = Task.Run(() =>
                    {
                        ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Solvent.Off", true);
                    });
                    taskA.ContinueWith(async x =>
                    {
                        await Task.Delay(1000);
                        ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Heat treatment.Solvent.Off", false);
