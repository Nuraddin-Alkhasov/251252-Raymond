...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class M2_HR_M
    {
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("CPU3.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Control voltage.from.On", true);
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("CPU3.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Control voltage.from.On", false);
        ...
        private void Button_Click_3(object sender, RoutedEventArgs e)
        {
            if (MessageBoxView.Show("@MachineOverview.Text53", "@MachineOverview.Text65", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                ...
                Task taskA = Task.Run(() =>
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Mode.Option.Forced", true);
                });
                taskA.ContinueWith(async x =>
                {
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Mode.Option.Forced", false);
        ...
        private void Button_Click_4(object sender, RoutedEventArgs e)
        {
            if (MessageBoxView.Show("@MachineOverview.Text53", "@MachineOverview.Text104", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                Task taskA = Task.Run(() =>
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Mode.Empty", true);
                });
                taskA.ContinueWith(async x =>
                {
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.00 Main.DB HMI Main.Production.from.Mode.Empty", false);
