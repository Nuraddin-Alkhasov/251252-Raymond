...
{
    [ExportAdapter("M2_Status_2")]
    public class M2_Status_2 : AdapterBase
    {
        ...
        private void CloseExecuted(object parameter)
        {
            ...
            Views.M2_Status_2 v = (Views.M2_Status_2)iRS.GetView("M2_Status_2");
        ...
        private void DeleteExecuted(object parameter)
        {
            if (MessageBoxView.Show("@Status.Text26", "@Status.Text27", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                ...
                Task taskA = Task.Run(() =>
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.from.Data.Delete", true);
                });
                taskA.ContinueWith(async x =>
                {
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.from.Data.Delete", false);
                    CloseExecuted(null);
        ...
        private void UpdateExecuted(object parameter)
        {
            if (MessageBoxView.Show("@Status.Text29", "@Status.Text28", MessageBoxButton.YesNo, MessageBoxResult.No, MessageBoxIcon.Question) == MessageBoxResult.Yes)
            {
                ...
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.from.Data.Update", true); 
                    await Task.Delay(1000);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.from.Data.Update", false);
                    CloseExecuted(null);
                });
        ...
        {
            ApplicationService.SetView("DialogRegion2", "Recipe_Selector", "M2_Status_2");
        }
        #endregion
        ...
        protected override void OnViewLoaded(object sender, ViewLoadedEventArg e)
        {
            ...
            {
                SPData = ApplicationService.ObjectStore.GetValue("M2_Status_2_KEY") as SP;
                ApplicationService.ObjectStore.Remove("M2_Status_2_KEY");
                Header = SPData.Header;

                SetData((uint)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.MR"));



                ;                switch (SPData.Type)
                {
                    case "Box": Content = new M2_Status_Box2(); break;
        ...
        void SetData(uint _mrId)
        {
            try 
            {
                ...
                uint OrderId = (uint)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.Order");
                if (OrderId > 0)
                {
                ...
                uint BoxId = (uint)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.Box");
                if (BoxId > 0)
                {
                ...
                uint ChargeId = (uint)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.Charge");
                if (ChargeId > 0)
                {
                ...
                uint RunId = (uint)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.Layer");
                if (RunId > 0)
                {
        ...
        public void SetData(int _mrId)
        {
            ...
            if (_mrId > 0)
            {
                ...
                byte actualLayer = (byte)ApplicationService.GetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[1].Actual");
                ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Header.MR", _mrId);
                ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Available", 1);
                ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Machine.Actual", 1);
                ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Layer[1].Set", counter);

                if (actualLayer < counter)
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Paint.Actual", actualLayer == 0 ? 0 : MR.Layers[actualLayer - 1].Paint.Header.Id);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Paint.Next", MR.Layers[actualLayer].Paint.Header.Id);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Machine.Next", MR.Layers[actualLayer].Machine);
                }
                else
                {
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Paint.Actual", MR.Layers[counter - 1].Paint.Header.Id);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Paint.Next", 0);
                    ApplicationService.SetVariableValue("CPU4.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.State.to.Data.Charge.Machine.Next", 0);
                }
            }
        }
