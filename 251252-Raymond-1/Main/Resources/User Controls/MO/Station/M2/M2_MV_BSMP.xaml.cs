...
{
    public partial class M2_MV_BSMP : UserControl
    {
        public M2_MV_BSMP()
        {
            InitializeComponent();
            ManipulatorPosition = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM HMI.Actual.State";
            BHState = "CPU3.PLC.Blocks.02 Basket handling.00 Main.DB BH HMI.Actual.State";
        }
        ...
        private MVBasket GetBasket(string Basket, Thickness margin, int ManiPos) 
        {
            ...
            {
                case "L":
                    temp.IsBasket = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Baskets.Available";
                    temp.IsMaterial = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Available";
                    temp.SetLayer = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[1].Set";
                    temp.ActualLayer = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Charge.Layer[1].Actual";
                    temp.AS = "Set";
                    if (ManiPos >= 0 && ManiPos <= 2 || ManiPos == 4)
                    {
                        temp.IsDischarge = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Baskets.Functions.Discharge";
                        temp.IsWatch = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Baskets.Functions.Watch";
                        temp.IsCheck = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Baskets.Functions.Check";
                    }
                    break;
                case "R":
                    temp.IsBasket = "CPU3.PLC.Blocks.02 Basket handling.02 BM.00 Main.DB BM PD.Baskets.Available";
