...
{
    public partial class M2_MV_CD : UserControl
    {
        public M2_MV_CD()
        {
            InitializeComponent();

            DTTemperature = "CPU3.PLC.Blocks.03 Basket coating.02 DT.03 Cooling.DB DT Cooling HMI.Actual.Temperature";
            ViscoCheck = "CPU3.PLC.Blocks.03 Basket coating.02 DT.00 Main.DB DT HMI.Actual.Viscosity.Expired";
        ...
        {
            ApplicationService.SetView("MainRegion", "M2_CD");
        }
    }
}
